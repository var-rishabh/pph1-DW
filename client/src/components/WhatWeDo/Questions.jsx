    ...
    return (
        <div className='questions'>
            <div className='question__container'>
                <div className='question__left--title'>
                    What We Do?
                </div>
                <div className='question'>

                    <div className='question__left one'>
                        <ContentBox quote={"We deliver fresh,100% natural, organic milk & milk products  A bunch of honest, hardworking, and ready-to-serve persons together aim to provide fresh natural milk to everyone. We aim to make people taste & realize again the importance of natural fresh milk."}/>
                    </div>
            ...
            <div className='question__container'>
                <div className='question__right--title'>
                    Why We Do?
                </div>
