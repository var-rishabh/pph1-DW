    ...
    return (
        <ModalContainer open={open} setOpen={setOpen}>
            <div className="vacation-modal">
                <div className="vacation-modal__title">
                ...
                <div className="vacation-modal__form">
                    ...
                    <div className="vacation-modal__form--sub">
                        <div className="vacation-modal__form--sub--title">
                            Subscription
                        </div>
                    ...
                    <div className="vacation-modal__form--vacation">
                        ...
                        <div className="vacation-modal__form--vacation--details">
                            <div className="vacation-modal__form--vacation--details--item">
                                ...
                                <div className="vacation-modal__form--vacation--details--item--value">
                                    <DatePicker onChange={setStartDate} value={startDate} format='dd/MM/yyyy' minDate={new Date()} maxDate={new Date(order?.end_date)} className="vacation-modal__form--vacation--details--item--value--input" />
                                </div>
                            </div>
                            <div className="vacation-modal__form--vacation--details--item">
                                <div className="vacation-modal__form--vacation--details--item--title">
                                ...
                                <div className="vacation-modal__form--vacation--details--item--value">
                                    <DatePicker onChange={setEndDate} value={endDate} format='dd/MM/yyyy' minDate={startDate} className="vacation-modal__form--vacation--details--item--value--input" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="vacation-modal__form--vacation--terms">
                                <div className='vacation-modal__form--vacation--terms--item'>1. All you subscription will be marked as paused and no delivery will be made during the vacation period.</div>
                                <div className='vacation-modal__form--vacation--terms--item'>2. Once any service is vacant for specific date then vacant date will not be changed.</div>
                        </div>
                    </div>
                </div>
            </div>
