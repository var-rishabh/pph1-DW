  ...
  return (
    <>
      ...
      <VacationModal
        ...
        order={vacationOrder}
      />
      <ProfileImageModal open={showProfileImageModal} setOpen={setShowProfileImageModal} />
    </>
  );
};
