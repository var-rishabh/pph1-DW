                ...
                <div className='profile__right'>
                    <div className='profile__right--personal'>
                        ...
                        <div className="profile__right--personal--buttons">
                            <button className="profile__right--personal--button" onClick={profileUpdateHanlder}>
                                Save
                            </button>
                        </div>
                    </div>
                    <div className='profile__right--service'>
                        ...
                        <button className="profile__right--service--button" onClick={() => window.location.href = '/product'}>
                            + Add More
                        </button>

                        <div className='profile__right--service--options'>
                            <button className="profile__right--service--options--button" onClick={() => setShowHistoryModal(true)}>
                                History
                            </button>
                            <button className="profile__right--service--options--button" onClick={() => setShowCalenderModal(true)}>
                                Calender
                            </button>
                        </div>
                    </div>
